...
public:
    MotorRoutines();
    static bool runToEnd(Moteus &motor, float velocity, float threashold_current);//TODO: Add default values
    ...
    static void moveToPosition(Moteus &motor, float position, float velocity, float current);
